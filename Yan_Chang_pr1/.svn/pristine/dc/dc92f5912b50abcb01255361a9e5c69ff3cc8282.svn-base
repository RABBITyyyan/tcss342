...
import mybagpackage.ArrayBagSorted;
 ...
 * @version Autumn 2016
 */
public class ArrayBagSortedTest {

	private ArrayBagSorted<Integer> al;//array list
	private ArrayBagUnsorted<String> bl;
	private ArrayBagUnsorted<String> cl;
	@Before
	public final void setup() {
		//al = new ArrayListUnsorted<String>();
		al = new ArrayBagSorted<Integer>(150);
		bl = new ArrayBagUnsorted<String>(150);
		cl = new ArrayBagUnsorted<String>(150);
	...
	public final void zeroCapacity() {
		al = new ArrayBagSorted<Integer>(0);
	}
	...
	public final void negativeCapacity() {
		al = new ArrayBagSorted<Integer>(-1);
	}
	...
	public final void set5HeadNextN() {
		...
		al.insert(5);
		al.set(1, 6);
		assertEquals("set 5 head next fail", "[1, 6, 3, 4, 5]", al.toString());
	}
	...
	public final void set5TailNextN() {
		...
		al.insert(5);
		al.set(3, 6);
		assertEquals("set 5 tail next fail", "[1, 2, 3, 6, 5]", al.toString());
	}
