...
import mybagpackage.LinkedBagUnsorted;
 ...
 * @version Spring 2019
 */
public class LinkedBagUnsortedTest {

	private LinkedBagUnsorted<String> al;//array list

	@Before
	public final void setup() {
		al = new LinkedBagUnsorted<String>();
	...
	public final void removeAtIndex5HeadNextN() {
		...
		al.insert("eee");
		al.removeAtIndex(1);
		assertEquals("removeAtIndex 5 head next fail", "[aaa, ccc, ddd, eee]", al.toString());
	}
