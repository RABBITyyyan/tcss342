...
public class DictionaryApp {
    ...
    public static void main(String[] args) {
        ...
        long totalTime_printing = 0;
        long startTime_printing = 0;
        long finishTime_printing = 0;
        ...
        if (!error) {
    		...
    		while ((currentWord = DictionaryApp.getWord(infile)) != null) {
    			...
    			case useHash:
    				// your code here
    				numTimes = hash.get(currentWord);
    				if(numTimes == null)
    					numTimes = 0;
    				numTimes++;
    				hash.put(currentWord, numTimes);
    				numInsertions++;
    				break;
    		...
    		Date startDate_printing;
    		Date finishDate_printing;  		
        	
    		// start the timer
    		startDate_printing = new Date();
    		startTime_printing = startDate_printing.getTime();
    		...
    		// stop the insertion timer
    		finishDate_printing = new Date();
    		finishTime_printing = finishDate_printing.getTime();
    		totalTime_printing = (finishTime_printing - startTime_printing);

    		System.out.println("Time to print the tree: ");
    		System.out.println(totalTime_printing + " ms.");
